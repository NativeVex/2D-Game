...
//        {
//			GameObject AttackClone = (GameObject)Instantiate(Attack, new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, this.gameObject.transform.position.z), Quaternion.Euler(0, 0, 0));;
//			if(_currentAnimationState == //this is fucked. use the goddamn dir mecanim setup I have and you don't need a 20 page long if
